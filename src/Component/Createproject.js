...
function Createproject(){
    ...
    let sendData = async(e)=>{
        ...
        let response = await fetch('https://cowork-backend-5nzc.onrender.com/api/createproject', {
            method: 'POST',
        ...
        if(response.ok){
            ...
            navigate(json.toLink, {
                state: { members: json.members, code: json.code, content: json.content }
            });
        }
    }
    ...
    return(
        <div className="flex flex-col items-center justify-start p-10">
            ...
            <form className="bg-white shadow-md rounded-lg p-8 w-[400px] flex flex-col gap-4" onSubmit={sendData}>
                <input className="border-b-2 border-[#654585] outline-none px-2 py-2 text-lg w-full" type="text" name="projectname" id="pjt-name" placeholder="Project Name"/>
